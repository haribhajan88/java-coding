...
abstract class BankAccount {
    ...
    protected void setBalance(double balance) { this.balance = balance; } // restricted setter
...
class SavingsAccount extends BankAccount implements Loanable {
    ...
    public boolean applyForLoan(double amount) {
        // simple rule: eligible if balance > 0.2 * amount
        return getBalance() >= 0.2 * amount;
    }

    @Override
    public double calculateLoanEligibility() {
        return getBalance() * 5; // simple multiplier
    }
}
...
class CurrentAccount extends BankAccount implements Loanable {
    ...
    @Override
    public double calculateInterest() {
        // current accounts usually have minimal/no interest
        return 0;
    }

    @Override
    public boolean applyForLoan(double amount) {
        // allow loan if overdraftLimit covers some part
