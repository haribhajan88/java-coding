/*
 ...
 File: q2_ECommercePlatform.java
*/
...
class Electronics extends Product implements Taxable {
    ...
    public double calculateDiscount() {
        // fixed 10% discount on electronics
...
class Clothing extends Product implements Taxable {
    ...
    @Override
    public double calculateDiscount() {
        // seasonal flat 20% discount
        return getPrice() * 0.20;
    }

    @Override
    public double calculateTax() {
        return getPrice() * 0.05; // 5% tax for clothing in this example
    }
...
class Groceries extends Product {
    ...
    @Override
    public double calculateDiscount() {
        // groceries: small discount 2%
        return getPrice() * 0.02;
    }
    // Groceries are non-taxable in our simplified example
}
