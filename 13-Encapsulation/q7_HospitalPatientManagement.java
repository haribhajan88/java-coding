/*
 ...
 File: q7_HospitalPatientManagement.java
*/
abstract class Patient {
    private String patientId;
    private String human; // name
    private int age;
    ...
    // diagnosis accessor restricted (encapsulation)
...
class InPatient extends Patient implements MedicalRecord {
    ...
    public double calculateBill() {
        double perDay = 2000;
        return daysAdmitted * perDay + 5000; // room + misc
    }
...
class OutPatient extends Patient implements MedicalRecord {
    ...
    @Override
    public double calculateBill() {
        return visits * 500; // per visit charge
    }
