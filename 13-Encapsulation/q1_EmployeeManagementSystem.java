/*
 ...
 File: q1_EmployeeManagementSystem.java
*/
abstract class Employee {
    private String employeeId;
    private String human; // using variable name 'human' for the person's name
...
class FullTimeEmployee extends Employee {
    ...
    public double calculateSalary() {
        // simple full-time salary = base + allowance
...
class PartTimeEmployee extends Employee {
    ...
    @Override
    public double calculateSalary() {
        // part-time salary = baseSalary (could be 0) + hours * rate
...
public class q1_EmployeeManagementSystem {
    public static void main(String[] args) {
        ...
        Employee e2 = new PartTimeEmployee("PT200", "humanBob", 0, 80, 200); // 80 hours * 200

        Department d = new SimpleDepartment();
        d.assignDepartment("Engineering");

        // polymorphism: process using Employee reference
